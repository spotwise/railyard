...
# and Linkedin login.
#
# This template works best with Rails 5.1.5. If you have multiple
# Rails versions you can select the one to use when running the
# template, e.g.:
#
#   rails _5.1.5_ new <site name> -m <template file>
#
# Changes from previous version:
# - Completely rewritten to use Rails 5.x and Bootstrap 4.x
#//
# Copyright © 2014-2018 Spotwise
#
...
begin
  ...
  twitter_key_development         = DevelopmentKeys::TWITTER_KEY
  twitter_secret_development      = DevelopmentKeys::TWITTER_SECRET
  linkedin_api_key_development    = DevelopmentKeys::LINKEDIN_API_KEY
  linkedin_secret_key_development = DevelopmentKeys::LINKEDIN_SECRET_KEY
  google_api_key_development      = DevelopmentKeys::GOOGLE_API_KEY
  google_secret_key_development   = DevelopmentKeys::GOOGLE_SECRET_KEY
  o365_api_key_development        = DevelopmentKeys::O365_API_KEY
  o365_secret_key_development     = DevelopmentKeys::O365_SECRET_KEY
...
inject_into_file "config/initializers/devise.rb", :before => %r{^end$} do <<-FILE
  ...
  o365_api_key      = Rails.env.production? ? "#{o365_api_key_production}" : "#{o365_api_key_development}"
  o365_secret_key   = Rails.env.production? ? "#{o365_secret_key_production}" : "#{o365_secret_key_development}"
...
#{ if login_facebook; <<FACEBOOK
  ...
  def self.find_for_facebook_oauth(auth, signed_in_resource=nil, session=nil)
    ...
    #{ "user = User.where(:o3_email => auth.info.email).first unless user" if login_office365 }
    p auth unless user
    unless user
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="navbar-collapse collapse" id="navbarsExampleDefault" style="">
        ...
        <ul class="nav navbar-nav navbar-right">
    		    <% if user_signed_in? then -%>
    			<li class="hidden-phone hidden-tablet"><%= image_tag current_user.avatar, :size => "32x32", :class => "rounded-circle", :style => "margin-top:4px;margin-left:16px;margin-right:4px" %></li>
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                  <%= link_to "Profile", '/users/edit', :class => 'dropdown-item' %>
...
run "wget -O app/assets/images/favicon.ico https://raw.githubusercontent.com/spotwise/railyard/master/assets/favicon.ico"
...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-4 text-center">
    <%= image_tag "seaweed.jpg", :class => 'rounded-circle', :width => 140, :height => 140, :'data-src' => "holder.js/140x140" %>
			<h2>Feature 2</h2>
			<p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
			<p><a class="btn btn-default" href="#">View details »</a></p>
		</div>
		<div class="col-md-4 text-center">
    <%= image_tag "shells.jpg", :class => 'rounded-circle', :width => 140, :height => 140, :'data-src' => "holder.js/140x140" %>
			<h2>Feature 3</h2>
...
#{ if login_facebook; <<FACEBOOK
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
    <a class="btn btn-lg btn-block btn-social btn-facebook" href="/users/auth/facebook"><span class="fa fa-facebook"></span> Log in with Facebook</a>
  </div>
</div>
FACEBOOK
end
...
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
	<a class="btn btn-lg btn-block btn-social btn-twitter" href="/users/auth/twitter"><span class="fa fa-twitter"></span>Log in with Twitter</a>
  </div>
</div>
TWITTER
end
...
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
	<a class="btn btn-lg btn-block btn-social btn-linkedin" href="/users/auth/linkedin"><span class="fa fa-linkedin"></span>Log in with Linkedin</a>
  </div>
</div>
LINKEDIN
end
...
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
	<a class="btn btn-lg btn-block btn-social btn-google" href="/users/auth/google_oauth2"><span class="fa fa-google-plus"></span>Log in with Google+</a>
  </div>
</div>
GOOGLE
end
...
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
	<a class="btn btn-lg btn-block btn-social btn-microsoft" href="/users/auth/office365"><span class="fa fa-windows"></span>Log in with Office 365</a>
  </div>
</div>
OFFICE
end
...
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
    <a class="btn btn-lg btn-block btn-social btn-facebook" href="/users/auth/facebook"><span class="fa fa-facebook"></span> Join with Facebook</a>
  </div>
</div>
FACEBOOK
end
...
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
	<a class="btn btn-lg btn-block btn-social btn-twitter" href="/users/auth/twitter"><span class="fa fa-twitter"></span>Join with Twitter</a>
  </div>
</div>
TWITTER
end
...
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
	<a class="btn btn-lg btn-block btn-social btn-linkedin" href="/users/auth/linkedin"><span class="fa fa-linkedin"></span>Join with Linkedin</a>
  </div>
</div>
LINKEDIN
end
...
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
	<a class="btn btn-lg btn-block btn-social btn-google" href="/users/auth/google_oauth2"><span class="fa fa-google-plus"></span>Join with Google+</a>
  </div>
</div>
GOOGLE
end
...
<div class="row">
	<div class="col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-4">
	<a class="btn btn-lg btn-block btn-social btn-microsoft" href="/users/auth/office365"><span class="fa fa-windows"></span>Join with Office 365</a>
  </div>
</div>
OFFICE
end
...
#{ if login_facebook; <<FACEBOOK
    ...
    <a class="btn btn-block btn-social btn-facebook <%= "disabled" if current_user.has_facebook? %>" href="/users/auth/facebook"><span class="fa fa-facebook"></span> Facebook</a>
	</div>
FACEBOOK
end
}
#{ if login_twitter; <<TWITTER
	<div style="width:200px;float:left;margin-right:30px">
	<a class="btn btn-block btn-social btn-twitter <%= "disabled" if current_user.has_twitter? %>" href="/users/auth/twitter"><span class="fa fa-twitter"></span>Twitter</a>
	</div>
TWITTER
end
}
#{ if login_linkedin; <<LINKEDIN
	<div style="width:200px;float:left;margin-right:30px">
	<a class="btn btn-block btn-social btn-linkedin <%= "disabled" if current_user.has_linkedin? %>" href="/users/auth/linkedin"><span class="fa fa-linkedin"></span>Linkedin</a>
	</div>
LINKEDIN
end
}
#{ if login_google; <<GOOGLE
	<div style="width:200px;float:left;margin-right:30px">
	<a class="btn btn-block btn-social btn-google <%= "disabled" if current_user.has_google? %>" href="/users/auth/google_oauth2"><span class="fa fa-google-plus"></span>Google+</a>
	</div>
GOOGLE
end
}
#{ if login_office365; <<OFFICE
  <div style="width:200px;float:left;margin-right:30px">
  <a class="btn btn-block btn-social btn-microsoft <%= "disabled" if current_user.has_office365? %>" href="/users/auth/office365"><span class="fa fa-windows"></span>Office 365</a>
  </div>
OFFICE
end
}
