...
# - Added Office 365 login option
#
# Copyright © 2014-2016 Spotwise
#

# TODO: Change as appropriately
footer = '&copy; <a href="http://www.example.com">Example Inc</a> 2016.'
...
<div class="row">
	<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
	<a class="btn btn-lg btn-block btn-social btn-microsoft" href="/users/auth/office365"><i class="fa fa-windows"></i>Log in with Office 365</a>
  </div>
</div>
OFFICE
end
...
<div class="row">
	<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
	<a class="btn btn-lg btn-block btn-social btn-microsoft" href="/users/auth/office365"><i class="fa fa-windows"></i>Join with Office 365</a>
  </div>
</div>
OFFICE
end
...
#{ if login_office365; <<OFFICE
  <div style="width:200px;float:left;margin-right:30px">
  <a class="btn btn-block btn-social btn-microsoft <%= "disabled" if current_user.has_office365? %>" href="/users/auth/office365"><i class="fa fa-windows" style="line-height:26px;"></i>Office 365</a>
  </div>
OFFICE
end
}
