...
#
# This template works best with Rails 4.2.10. If you have multiple
# Rails versions you can select the one to use when running the
# template, e.g.:
#
#   rails _4.2.10_ new <site name> -m <template file>
#
# Changes from previous version:
# - Updated to work with Rails 4.2.10
#
# Copyright © 2014-2017 Spotwise
#

# TODO: Change as appropriately
footer = '&copy; <a href="http://www.example.com">Example Inc</a> 2017.'
...
#{ if login_facebook; <<FACEBOOK
    ...
    <a class="btn btn-block btn-social btn-facebook <%= "disabled" if current_user.has_facebook? %>" href="/users/auth/facebook"><span class="fa fa-facebook" style="line-height:26px;"></span> Facebook</a>
	</div>
FACEBOOK
end
}
#{ if login_twitter; <<TWITTER
	<div style="width:200px;float:left;margin-right:30px">
	<a class="btn btn-block btn-social btn-twitter <%= "disabled" if current_user.has_twitter? %>" href="/users/auth/twitter"><span class="fa fa-twitter" style="line-height:26px;"></span>Twitter</a>
	</div>
TWITTER
end
}
#{ if login_linkedin; <<LINKEDIN
	<div style="width:200px;float:left;margin-right:30px">
	<a class="btn btn-block btn-social btn-linkedin <%= "disabled" if current_user.has_linkedin? %>" href="/users/auth/linkedin"><span class="fa fa-linkedin" style="line-height:26px;"></span>Linkedin</a>
	</div>
LINKEDIN
end
}
#{ if login_google; <<GOOGLE
	<div style="width:200px;float:left;margin-right:30px">
	<a class="btn btn-block btn-social btn-google <%= "disabled" if current_user.has_google? %>" href="/users/auth/google_oauth2"><span class="fa fa-google-plus" style="line-height:26px;"></span>Google+</a>
	</div>
GOOGLE
end
}
#{ if login_office365; <<OFFICE
  <div style="width:200px;float:left;margin-right:30px">
  <a class="btn btn-block btn-social btn-microsoft <%= "disabled" if current_user.has_office365? %>" href="/users/auth/office365"><span class="fa fa-windows" style="line-height:26px;"></span>Office 365</a>
  </div>
OFFICE
end
}
