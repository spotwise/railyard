...
if login_google
  generate(:migration, "AddGoogleToUsers go_email:string go_first_name:string go_last_name:string \
    go_name:string go_image:text --force")
  p << %w{ :go_email :go_first_name :go_last_name :go_name :go_image }
end
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
		  ...
		  <ul class="nav navbar-nav navbar-right">
		    <% if user_signed_in? then -%>
			<li class="hidden-phone hidden-tablet"><%= image_tag current_user.avatar, :size => "32x32", :class => "img-circle", :style => "margin-top:13px;margin-left:16px;margin-right:4px" %></li>  
            <li class="dropdown">
...
<div class="jumbotron">
	...
	<%= image_tag "banner-flowers.jpg", :class => "img-responsive" %>
	</div>
</div>
...
<% else -%>
You are using an external authentication provider. There are no settings you can change at this time.
<% end -%>
